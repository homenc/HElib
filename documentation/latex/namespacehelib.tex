...
class \mbox{\hyperlink{structhelib_1_1version}{version}}
\begin{DoxyCompactList}\small\item\em The class acts as a namespace with all members static. Holds the version number for this code of H\+Elib. \end{DoxyCompactList}\item 
...
\item 
double \mbox{\hyperlink{namespacehelib_acd21b28ce9fd73962e1bec7d50c2f5fb}{lwe\+Estimate\+Security}} (int n, double log2\+Alpha\+Inv, int hwt)
...
\mbox{\Hypertarget{namespacehelib_acd21b28ce9fd73962e1bec7d50c2f5fb}\label{namespacehelib_acd21b28ce9fd73962e1bec7d50c2f5fb}} 
\index{helib@{helib}!lweEstimateSecurity@{lweEstimateSecurity}}
\index{lweEstimateSecurity@{lweEstimateSecurity}!helib@{helib}}
\doxysubsubsection{\texorpdfstring{lweEstimateSecurity()}{lweEstimateSecurity()}}
{\footnotesize\ttfamily double helib\+::lwe\+Estimate\+Security (\begin{DoxyParamCaption}\item[{int}]{n,  }\item[{double}]{log2\+Alpha\+Inv,  }\item[{int}]{hwt }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



An estimate for the security-\/level. This has a lower bound of 0. 

This function uses experimental affine approximations to the lwe-\/estimator from \href{https://bitbucket.org/malb/lwe-estimator/raw/HEAD/estimator.py}{\texttt{ https\+://bitbucket.\+org/malb/lwe-\/estimator/raw/\+H\+E\+A\+D/estimator.\+py}}, from Aug-\/2020 (see script in misc/estimator/lwe-\/estimator.\+sage). Let X = n / log(1/alpha), the security level is estimated as follows\+:


\begin{DoxyItemize}
\item dense \{-\/1,0,1\} keys\+: security $\sim$ 3.\+8$\ast$X -\/20
\item sparse keys (weight=450)\+: security $\sim$ 3.\+55$\ast$X -\/12
\item sparse keys (weight=420)\+: security $\sim$ 3.\+5$\ast$X -\/10
\item sparse keys (weight=390)\+: security $\sim$ 3.\+45$\ast$X -\/7
\item sparse keys (weight=360)\+: security $\sim$ 3.\+4$\ast$X -\/5
\item sparse keys (weight=330)\+: security $\sim$ 3.\+35$\ast$X -\/4
\item sparse keys (weight=300)\+: security $\sim$ 3.\+3$\ast$X -\/3
\item sparse keys (weight=270)\+: security $\sim$ 3.\+2$\ast$X +1
\item sparse keys (weight=240)\+: security $\sim$ 3.\+1$\ast$X +3
\item sparse keys (weight=210)\+: security $\sim$ 3$\ast$X +6
\item sparse keys (weight=180)\+: security $\sim$ 2.\+83$\ast$X +10
\item sparse keys (weight=150)\+: security $\sim$ 2.\+67$\ast$X +13
\item sparse keys (weight=120)\+: security $\sim$ 2.\+4$\ast$X +19 
\end{DoxyItemize}\mbox{\Hypertarget{namespacehelib_a454437c5c0e3415fe2a360fa48a3eb5f}\label{namespacehelib_a454437c5c0e3415fe2a360fa48a3eb5f}} 
