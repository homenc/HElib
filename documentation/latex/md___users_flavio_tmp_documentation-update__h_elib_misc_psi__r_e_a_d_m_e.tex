\hypertarget{md___users_flavio_tmp_documentation-update__h_elib_misc_psi__r_e_a_d_m_e_autotoc_md41}{}\doxysection{Prequisites}\label{md___users_flavio_tmp_documentation-update__h_elib_misc_psi__r_e_a_d_m_e_autotoc_md41}

\begin{DoxyItemize}
\item You must have bats-\/core installed.
\item Build and install H\+Elib.
\item Build the utilities directory.
\end{DoxyItemize}\hypertarget{md___users_flavio_tmp_documentation-update__h_elib_misc_psi__r_e_a_d_m_e_autotoc_md42}{}\doxysection{Build the tests}\label{md___users_flavio_tmp_documentation-update__h_elib_misc_psi__r_e_a_d_m_e_autotoc_md42}
...
\end{DoxyEnumerate}\hypertarget{md___users_flavio_tmp_documentation-update__h_elib_misc_psi__r_e_a_d_m_e_autotoc_md43}{}\doxysection{Run the tests}\label{md___users_flavio_tmp_documentation-update__h_elib_misc_psi__r_e_a_d_m_e_autotoc_md43}
