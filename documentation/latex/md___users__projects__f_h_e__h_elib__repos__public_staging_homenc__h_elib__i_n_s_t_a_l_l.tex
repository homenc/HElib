...
{\bfseries{Please read these instructions in full to better choose the type of build that is better for you.}}\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md12}{}\doxysection{General prerequisites}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md13}{}\doxysection{Option 1\+: package build (recommended for most users)}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md13}
...
Please note that if changing from library build to package build, it is safer to use a clean build directory.\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md14}{}\doxysubsection{Instructions}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md14}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ctest -\/R helib\_check}
\end{DoxyCode}

\end{DoxyEnumerate}

Detailed H\+Elib-\/specific test logs can be found in {\ttfamily dependencies/\+Build/helib\+\_\+external/\+Testing/\+Temporary/\+Last\+Test.\+log}.
...
of course, if the {\ttfamily C\+M\+A\+K\+E\+\_\+\+I\+N\+S\+T\+A\+L\+L\+\_\+\+P\+R\+E\+F\+IX} was kept as the default {\ttfamily /usr/local} or some other system-\/wide path, step 5 may require {\ttfamily sudo} privileges.\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md15}{}\doxysection{Option 2\+: library build (advanced)}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md15}
...
of course, if the {\ttfamily C\+M\+A\+K\+E\+\_\+\+I\+N\+S\+T\+A\+L\+L\+\_\+\+P\+R\+E\+F\+IX} was kept as the default {\ttfamily /usr/local} or some other system-\/wide path, step 5 may require {\ttfamily sudo} privileges.\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md16}{}\doxysection{Building dependencies (for option 2)}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md16}
\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md17}{}\doxysubsection{G\+MP}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md17}
...
{\bfseries{N\+O\+TE\+:}} For further options when building G\+MP, run {\ttfamily ./configure -\/-\/help} in step 3.\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md18}{}\doxysubsection{N\+TL}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md18}
...
{\bfseries{N\+O\+TE}}\+: if linking against a non-\/system G\+MP, pass {\ttfamily G\+M\+P\+\_\+\+P\+R\+E\+F\+IX=$<$path/to/gmp$>$} to the {\ttfamily ./configure} step.\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md19}{}\doxysection{H\+Elib build options}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md19}
\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md20}{}\doxysubsection{Generic options}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md20}
...
\end{DoxyItemize}\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md21}{}\doxysubsection{Parameters specific to option 1 (package build)}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md21}
...
\end{DoxyItemize}\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md22}{}\doxysubsection{Parameters specific to option 2 (library build)}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md22}

\begin{DoxyItemize}
\item {\ttfamily E\+N\+A\+B\+L\+E\+\_\+\+L\+E\+G\+A\+C\+Y\+\_\+\+T\+E\+ST=O\+N/\+O\+FF} (default is {\ttfamily O\+FF})\+: Build old test system (deprecated).
\item {\ttfamily G\+M\+P\+\_\+\+D\+IR}\+: Prefix of the G\+MP library.
\item {\ttfamily N\+T\+L\+\_\+\+D\+IR}\+: Prefix of the N\+TL library.
\end{DoxyItemize}\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md23}{}\doxysection{Using H\+Elib in a project}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md23}
\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md24}{}\doxysubsection{Standard method}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md24}
After {\ttfamily make install} has been run in either option 1 or option 2, one can find the required shared library files to link against in {\ttfamily lib} and the header files in {\ttfamily include}. These can be used in the preferred way with your build system of choice.\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md25}{}\doxysubsection{Package build with cmake}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md25}
...
\end{DoxyEnumerate}\hypertarget{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md26}{}\doxysubsection{Example}\label{md___users__projects__f_h_e__h_elib__repos__public_staging_homenc__h_elib__i_n_s_t_a_l_l_autotoc_md26}
