...
public:
   ...
   **/
  explicit Ptxt(const FHEcontext& context);
   ...
   **/
  Ptxt(const FHEcontext& context, const SlotType& value);
  ...
  Ptxt(const FHEcontext& context, const NTL::ZZX& value);
   ...
   **/
  Ptxt(const FHEcontext& context, const std::vector<SlotType>& data);
   ...
   **/
  template <typename T>
  Ptxt(const FHEcontext& context, const std::vector<T>& data) :
   ...
   **/
  static SlotType convertToSlot(const FHEcontext& context, long slot);
