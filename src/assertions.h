 ...
 *
 * ```
 helib::assertTrue<helib::InvalidArgument>(some_var > 0, "some_var must be positive!");
 * ```
 *
 ...
 * @note ExceptionTy first and T defaulted to void so that one can specify only ExceptionTy,
 ...
 * @param message the message of the exception raised if the two values are not equal.
 ...
 * @param a the first element to be compared.
 * @param b the second element to be compared.
 * @param message the message of the exception raised if the two values are equal.
