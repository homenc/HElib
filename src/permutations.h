...
// class SlicePerm : Permuting subcubes (rows/slices) of a hypercube.
// 
...
public:
  ...
  // Break a row permutation into column-row-column format. The input permutes
  ...
  // This method cannot permute in-place, it is assumed that rho2 and *this
  // point to disjoint objects.
...
// class ColPerm : Permuting a single dimension (column) of a hypercube
//
