...
extern template<class T> ostream& printVec(ostream& s, const Vec<T>& v, long nCoeffs=40);
...
//{ p, phi(m),  m,    d, m1,  m2, m3,   g1,    g2,    g3,ord1,ord2,ord3}
  ...
  {  2,  1728,  4095, 12,  7,  5, 117,  2341,  3277, 3641,  6,  4,   6}, // m=(3^2)*5*7*{13} m/phim(m)=2.36 C=26 D=3 E=2
  {  2,  2304,  4641, 24,  7,  3, 221,  3979,  3095, 3760,  6,  2,  -8}, // m=3*7*(13)*{17} :-( m/phim(m)=2.01 C=45 D=4 E=3
